...
public class IssueBook extends javax.swing.JFrame {
    ...
    String  id, title, student_id, student_name ;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Book issue date & Title will be added by system automatically");
...
student_id = jTextField3.getText();
student_name = jTextField4.getText();
...
else 
{
    ...
    JOptionPane.showMessageDialog(this,"Required Book is: "+title);
    int j = stmt.executeUpdate("INSERT INTO issued_books VALUES('"+id+"','"+title+"','"+student_id+"','"+student_name+"',CURRENT_TIMESTAMP)");
    // Dont forget strings should be in single quotes
    if(j==1)
        JOptionPane.showMessageDialog(this,"Book Issued");
    else
        JOptionPane.showMessageDialog(this,"Book Not Issued!! Try Again.");
}
